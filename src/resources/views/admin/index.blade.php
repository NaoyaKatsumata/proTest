...
<body class="bg-gray-100">
    ...
    <div class="flex mx-[5%] mt-8 justify-between">
        ...
        <form id="price-sort" action="/admin/index" method="post" class="flex gap-0 ml-auto mr-0">
            @csrf
    ...
    <div class="my-[5%] mx-[5%]">
        <p class="text-xl">コメントを表示したい店舗を選択してください</p>
        <div class="flex flex-wrap w-[90%] mx-auto mt-8">
            <!-- 店舗カード -->
            @foreach($shops as $shop)
            <div class="flex-column break-words w-[49%] h-[200px] mx-[0.5%] mb-4 bg-white rounded-[10px] shadow-[3px_3px_0px_0px_rgba(0,0,0,0.3)] md:w-[24%] h-[200px] mx-[0.5%]">
                ...
                <div class="mx-4">
                    ...
                    <form class="flex w-full content-center " action="/admin/review-all" method="get">
                        <input type="hidden" name="shopId" value="{{$shop->id}}">
                        <input type="submit" class="ml-auto mr-0 px-4 py-2 bg-blue-500 text-white rounded-[5px]" value="詳しくみる"/>
                    </form>
                </div>
            </div>
            @endforeach
