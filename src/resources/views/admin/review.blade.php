            ...
            <div class="w-full">
                <div class="flex">
                    ...
                    <form id="reviewValue" class="w-[60%]" action="/review" method="post" enctype="multipart/form-data">
                        ...
                        @endif
                        <input type="hidden" name="shopId" value="{{$shop->id}}">
                        <input type="hidden" id="review" name="score" value="">
                        <div class="mx-[10%] mt-8">
                            <p class="text-xl">口コミを投稿</p>
                            <textarea id="myTextarea" cols="100" rows="5" maxlength="400" name="comment" class="w-full mt-4 bg-gray-100 border border-gray-300 resize-none" placeholder="商品の説明を入力" oninput="updateCount()"></textarea>
